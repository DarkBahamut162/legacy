...
return Def.ActorFrame {
	...
	LoadActor("_grid")..{
		...
		OnCommand=function(self) self:zoomto(SCREEN_WIDTH+1,SCREEN_HEIGHT):diffuse(Color("Black")):diffuseshift():effecttiming((1/8)*4,0,(7/8)*4,0):effectclock('beatnooffset')
			:effectcolor2(Color("Black")):effectcolor1(Color.Alpha(Color("Black"),0.45)):fadebottom(0.25):fadetop(0.25):croptop(48/480):cropbottom(48/480):diffusealpha(0.345) end
	}
}